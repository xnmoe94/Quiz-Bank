...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-primary">
    <a class="navbar-brand" href="index.php">Student Dashbord</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="enroll_exam.php">Exam List</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="change_password.php">Reset Password</a>
        </li>
        <li class="nav-item">
